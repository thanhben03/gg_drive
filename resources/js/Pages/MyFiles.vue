...
import DownloadFilesButton from "@/Components/app/DownloadFileButton.vue";
import {emitter, ON_SEARCH, SHOW_CONTEXT_MENU, SHOW_RENAME, showSuccessNotification} from "@/event-bus.js";
...
const showInputChangeName = ref(false);
let search = ref('');
...
function onContextMenu(e, file) {
    ...
    //show our menu
    emitter.emit(SHOW_CONTEXT_MENU,{e,file})

}

function onShowRename() {
    showInputChangeName.value = true;
}
...
onMounted(() => {
    ...
    emitter.on(SHOW_RENAME, onShowRename)
