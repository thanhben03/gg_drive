        ...
        <div class="p-6">
            ...
            <div class="mt-6">
                ...
                <TextInput type="text" ref="emailInput" id="shareEmail" v-model="form.email"
                    ...
                    class="mt-1 block w-full" placeholder="Enter Email Address" @keyup.enter="share" />
...
import {emitter, FILE_SHARE_FROM_MENU, showSuccessNotification} from "@/event-bus.js";
